	...
	program define		masterDofilePart0 
		...
		file write  	`newHandle' 	///
							...
							_n ///					
							_col(25) "Example:" _n ///
							_col(25) "\$BL_dtRaw/baseline_survey_v1.csv" _n ///
							_col(25) "\$BL_dtRaw/baseline_survey_v2.csv" _n ///
							_col(25) "\$moniData/monitor2016_data.xlsx" _n ///
							_n ///																			
							...
							_n ///					
							_col(25) "Example:" _n ///
							_col(25) "\$BL_dtFinal/baseline_clean.dta" _n ///
							_col(25) "\$BL_dtFinal/baseline_constructs.dta" _n ///
		...
		writeDevisor `newTextFile' `newHandle' 0 Standardize 
		...
		file write  	`newHandle' 	///							
							...
							_col(8)"\`r(version)'" 				_col(40) "//This line is needed to actually set the version from the command above" _n
...
cap program drop 	masterDofilePart1
	program define	masterDofilePart1
		...
		args  newTextFile newHandle projectDir
		...
		writeDevisor `newTextFile' `newHandle' 1 Globals
