...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv15") savexlsx("run/iebaltab/outputs/iebt-xlsx15") savetex("run/iebaltab/outputs/iebt-tex15") texnotefile("run/iebaltab/outputs/iebt-tex15-note") groupvar(tmt_cl) replace ftest control(1) stats(pair(se)) cov(mpg) fixed(foreign)
