...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv20") savexlsx("run/iebaltab/outputs/iebt-xlsx20") savetex("run/iebaltab/outputs/iebt-tex20") texnotefile("run/iebaltab/outputs/iebt-tex20-note") groupvar(tmt_cl) replace stats(desc(var) pair(t)) vce(robust)
