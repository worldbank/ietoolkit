...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(tmt) order(2) savetex("run/iebaltab/outputs/3g-order.tex") replace
