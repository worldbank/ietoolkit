...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(tmt) control(0) savetex("run/iebaltab/outputs/3g-control.tex") replace
