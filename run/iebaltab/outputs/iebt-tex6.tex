...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv6") savexlsx("run/iebaltab/outputs/iebt-xlsx6") savetex("run/iebaltab/outputs/iebt-tex6") texnotefile("run/iebaltab/outputs/iebt-tex6-note") groupvar(tmt) replace ftest feqtest total rowvarlabels cov(mpg) fixed(foreign) addnote("Many groups, rowvarlabels")
