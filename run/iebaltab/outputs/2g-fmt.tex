...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) format("%9.2f") savetex("run/iebaltab/outputs/2g-fmt.tex") replace
