...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) starsnoadd savetex("run/iebaltab/outputs/iebaltab2/2g-nostars.tex") replace
