...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) stats(pair(p)) savetex("run/iebaltab/outputs/iebaltab2/2g-pair.tex") replace
