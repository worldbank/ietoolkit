...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(tmt) total savetex("run/iebaltab/outputs/iebaltab2/3g-total.tex") replace
