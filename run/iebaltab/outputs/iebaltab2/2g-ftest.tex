...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) fixedeffect(stratum) ftest savetex("run/iebaltab/outputs/iebaltab2/2g-ftest.tex") replace
