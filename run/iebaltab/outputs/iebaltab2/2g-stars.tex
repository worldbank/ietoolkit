...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) starlevels(.05 .01 .001) savetex("run/iebaltab/outputs/iebaltab2/2g-stars.tex") replace
