...
%%% iebaltab mpg headroom trunk weight length turn price , savecsv("run/iebaltab/outputs/iebt-csv22") savexlsx("run/iebaltab/outputs/iebt-xlsx22") savetex("run/iebaltab/outputs/iebt-tex22") texnotefile("run/iebaltab/outputs/iebt-tex22-note") groupvar(tmt_cl) replace onerow stats(pair(p)) starlevels(.4 .2 .001)
