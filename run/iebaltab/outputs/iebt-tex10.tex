...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv10") savexlsx("run/iebaltab/outputs/iebt-xlsx10") savetex("run/iebaltab/outputs/iebt-tex10") texnotefile("run/iebaltab/outputs/iebt-tex10-note") groupvar(tmt_cl) replace vce(cluster test_cluster_var) ftest feqtest total cov(mpg) fixed(foreign) addnote("added cluster")
