...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv19") savexlsx("run/iebaltab/outputs/iebt-xlsx19") savetex("run/iebaltab/outputs/iebt-tex19") texnotefile("run/iebaltab/outputs/iebt-tex19-note") groupvar(tmt_cl) replace stats(pair(beta))
