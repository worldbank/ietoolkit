...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(tmt) covariates(foreign) stats(pair(p)) savetex("run/iebaltab/outputs/3g-cov.tex") replace
