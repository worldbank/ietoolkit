...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) control(0) savetex("run/iebaltab/outputs/2g-control.tex") replace
