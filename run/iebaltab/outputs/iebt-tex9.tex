...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv9") savexlsx("run/iebaltab/outputs/iebt-xlsx9") savetex("run/iebaltab/outputs/iebt-tex9") texnotefile("run/iebaltab/outputs/iebt-tex9-note") groupvar(tmt_cl) replace ftest feqtest cov(mpg) fixed(foreign) addnote("Warning for missing value in fixedeffect(foreign) and in covariates(mpg)")
