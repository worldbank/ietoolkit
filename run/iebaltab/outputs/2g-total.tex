...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) total savetex("run/iebaltab/outputs/2g-total.tex") replace
