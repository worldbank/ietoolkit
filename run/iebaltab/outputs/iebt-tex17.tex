...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv17") savexlsx("run/iebaltab/outputs/iebt-xlsx17") savetex("run/iebaltab/outputs/iebt-tex17") texnotefile("run/iebaltab/outputs/iebt-tex17-note") groupvar(tmt_cl) replace stats(pair(nrmb)) cov(mpg) fixed(foreign)
