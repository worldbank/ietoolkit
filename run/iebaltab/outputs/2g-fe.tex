...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) fixedeffect(stratum) savetex("run/iebaltab/outputs/2g-fe.tex") replace
