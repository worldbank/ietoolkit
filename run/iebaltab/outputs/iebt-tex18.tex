...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv18") savexlsx("run/iebaltab/outputs/iebt-xlsx18") savetex("run/iebaltab/outputs/iebt-tex18") texnotefile("run/iebaltab/outputs/iebt-tex18-note") groupvar(tmt_cl) replace stats(pair(diff))
