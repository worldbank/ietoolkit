...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv14") savexlsx("run/iebaltab/outputs/iebt-xlsx14") savetex("run/iebaltab/outputs/iebt-tex14") texnotefile("run/iebaltab/outputs/iebt-tex14-note") groupvar(tmt_cl) replace ftest feqtest control(1) stats(pair(none)) cov(mpg) fixed(foreign)
