...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv12") savexlsx("run/iebaltab/outputs/iebt-xlsx12") savetex("run/iebaltab/outputs/iebt-tex12") texnotefile("run/iebaltab/outputs/iebt-tex12-note") groupvar(tmt_cl) replace onerow vce(cluster test_cluster_var) ftest feqtest total cov(mpg) fixed(foreign) addnote("added onerow and cluster") browse
