...
%%% iebaltab weight , savecsv("run/iebaltab/outputs/iebt-csv24b") savexlsx("run/iebaltab/outputs/iebt-xlsx24b") savetex("run/iebaltab/outputs/iebt-tex24b") replace groupvar(tmt_cl) nonote
