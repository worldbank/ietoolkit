...
%%% iebaltab weight price , groupvar(tmt_cl) replace ftest feqtest control(1) savetex("C:/Users/wb462869/github/ietoolkit/run/iebaltab/outputs/iebaltab1/iebt-tex2") cov(mpg) fixed(foreign)
