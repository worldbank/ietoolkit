...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebaltab1/iebt-csv18") savexlsx("run/iebaltab/outputs/iebaltab1/iebt-xlsx18") savetex("run/iebaltab/outputs/iebaltab1/iebt-tex18") texnotefile("run/iebaltab/outputs/iebaltab1/iebt-tex18-note") groupvar(tmt_cl) replace stats(pair(diff))
