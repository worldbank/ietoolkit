...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) vce(cluster stratum) stats(pair(p)) savetex("run/iebaltab/outputs/2g-cluster.tex") replace
