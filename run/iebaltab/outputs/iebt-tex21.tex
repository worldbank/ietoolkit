...
%%% iebaltab weight price , savecsv("run/iebaltab/outputs/iebt-csv21") savexlsx("run/iebaltab/outputs/iebt-xlsx21") savetex("run/iebaltab/outputs/iebt-tex21") texnotefile("run/iebaltab/outputs/iebt-tex21-note") groupvar(tmt_cl) replace stats(desc(sd) pair(p)) vce(bootstrap)
