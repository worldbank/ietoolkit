...
do "${ietoolkit}/run/iedorep/iedorep-target-2.do"
 post posty (26)  ("") ("") ("") ("") ("") ("") (`""/Users/bbdaniels/GitHub/ietoolkit/run/iedorep/iedorep-target-2.do""') 
if ("`c(rngstate)'" != "``theRNG''") {
post posty (26)  ("") ("") ("") ("") ("") ("") ("")    
local `theRNG' = "`c(rngstate)'" 
local `allRNGS' = "``allRNGS'' `c(rngstate)'" 
...
do "${ietoolkit}/run/iedorep/iedorep-target-2.do"
 post posty (28)  ("") ("") ("") ("") ("") ("") (`""/Users/bbdaniels/GitHub/ietoolkit/run/iedorep/iedorep-target-2.do""') 
if ("`c(rngstate)'" != "``theRNG''") {
post posty (28)  ("") ("") ("") ("") ("") ("") ("")    
local `theRNG' = "`c(rngstate)'" 
local `allRNGS' = "``allRNGS'' `c(rngstate)'" 
...
set seed 123455
if ("`c(rngstate)'" != "``theRNG''") {
di as err `" local `whichRNG' = ``whichRNG'' + 1 "'
di as err `" ``whichRNG'' "'
-
di as err `" ("`c(rngstate)'" != "`: word ``whichRNG'' of ``allRNGS'''") "'
...
if ("`r(datasignature)'" != "``theDATA''") {
local `theDATA' = "`r(datasignature)'" 
cap cf _all using `31'
if _rc != 0 {
post posty (31)  ("Changed") ("ERROR! ") ("") ("") ("") ("") ("")  
}
}
postclose posty
use `posty' , clear
