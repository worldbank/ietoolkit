...
%%% iebaltab weight price , groupvar(tmt_cl) replace ftest feqtest control(1) savetex("C:/Users/wb462869/GitHub/ietoolkit/run/output/iebaltab/iebt-tex3") cov(mpg) fixed(foreign) texcolwidth(4cm) tableaddnote("Options used: texcolwidth(3cm) short first column ")
