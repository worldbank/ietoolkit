...
%%% iebaltab price mpg trunk headroom weight length turn displacement gear_ratio, grpvar(foreign) fixedeffect(stratum) ftest savetex("C:/Users/luizaandrade/Documents/GitHub/ietoolkit/run/output/iebaltab/2g-feqtest.tex") replace
...
gear\_ratio   & 52    &     2.807    & 22    &     3.507    & 74    &    -0.701   \\
 &   &     0.047  &   &     0.063  &   &   \\
\hline \\[-1.8ex]
F-test of joint significance (F-stat) & &   & &     & &         .v   \\
F-test, number of observations & &   & &   & &  .v   \\
\hline \\[-1.8ex]
